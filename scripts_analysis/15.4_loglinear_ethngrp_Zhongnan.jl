...
pooled_df_Zhongnan = @transform(pooled_df, :region = "South Central")
temporal_df_Zhongnan = @transform(temporal_df, :region = "South Central")

println(pooled_df_Zhongnan)
println(temporal_df_Zhongnan)