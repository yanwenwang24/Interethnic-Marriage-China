...
@subset!(odd_ratio_df, :ethngrp .== "Hui" .|| :ethngrp .== "Mongolian"  .|| :ethngrp .== "Tibetan")
...
odd_ratio_plt = data(
    @subset(odd_ratio_df, :ethngrp .!= "Kazakh" .&& :ethngrp .!= "Uyghur")
    ) * (
    mapping(
        :ethngrp => "",
...
save("graphs/inter_odds_edu_Xibei.png", f; px_per_unit=2)
