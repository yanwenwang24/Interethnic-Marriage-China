...
# census_1990 = DataFrame(load("data/raw/1990_census.dta"))
# Arrow.write("data/raw/census_1990.arrow", census_1990)

# Read arrow file
census_1990 = DataFrame(Arrow.Table("data/raw/census_1990.arrow"))
